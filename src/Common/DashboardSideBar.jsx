...
export default function Sidebar() {
  ...
  const menuItems = [
    ...
    { name: "Dining", path: "/admin/dining-images", icon: <Utensils size={20} /> },
  ...
  return (
    <aside className="fixed left-0 top-0 h-screen w-64 bg-white border-r border-gray-100 shadow-sm flex flex-col">
      ...
      <div className="p-4 border-t border-gray-100">
        <button className="flex items-center gap-4 w-full px-4 py-3 text-sm font-medium text-gray-500 hover:text-red-600 transition-colors uppercase tracking-wider text-[12px]">
          <LogOut size={20} />
          <span>Logout</span>
        </button>
      </div>
