  ...
  const staticRooms = [
    {
      ...
      status: "available",
      image:
        "https://images.unsplash.com/photo-1582719478250-c89cae4dc85b?w=400&fit=crop",
      capacity: "2 Adults",
    ...
    },
    {
      ...
      status: "available",
      image:
        "https://images.unsplash.com/photo-1571896349842-33c89424de2d?w=400&fit=crop",
      capacity: "4 Adults",
      facilities: ["AC", "WiFi", "TV"],
    },
  ];
          ...
          <table className="w-full">
            <thead>
              <tr className="bg-gray-50 border-b border-gray-100">
                <th className="px-6 py-4 text-left text-[11px] font-bold text-gray-400 uppercase tracking-[2px]">
                  Room Info
                </th>
                <th className="px-6 py-4 text-left text-[11px] font-bold text-gray-400 uppercase tracking-[2px]">
                  Price/Night
                ...
                <th className="px-6 py-4 text-right text-[11px] font-bold text-gray-400 uppercase tracking-[2px]">
                  Actions
                </th>
              </tr>
            </thead>
            <tbody className="divide-y divide-gray-50">
              {filteredRooms.map((room) => (
                ...
                >
                      ...
                      <div>
                        ...
                        <div className="flex gap-2 mt-1">
                          {room.facilities.map((f, i) => (
                            <span
                              key={i}
                              className="text-[10px] text-[#C6A45C] uppercase tracking-wider"
                            >
                              · {f}
                            </span>
                          ))}
                  ...
                  <td className="px-6 py-5 text-[12px] text-gray-600 uppercase tracking-wider">
                    {room.capacity}
                  </td>
                  <td className="px-6 py-5 text-right">
                    <div className="flex items-center justify-end space-x-3">
                      <button
                        title="View"
                        className="p-2 text-gray-400 hover:text-[#C6A45C] transition-colors"
                      >
                        <Eye size={18} />
                      </button>
                      <button
