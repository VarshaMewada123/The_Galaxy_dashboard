...
const HotelImages = () => {
  ...
  useEffect(() => {
    setCurrentImages([
      {
        id: 1,
        url: "https://images.unsplash.com/photo-1566073771259-6a8506099945?w=400&fit=crop",
        name: "hotel-main-1.jpg",
      },
      {
        id: 2,
        url: "https://images.unsplash.com/photo-1571896349842-33c89424de2d?w=400&fit=crop",
        name: "hotel-lobby.jpg",
      },
      {
        id: 3,
        url: "https://images.unsplash.com/photo-1582719478250-c89cae4dc85b?w=400&fit=crop",
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-gray-500">
            Update images for hotel landing page (Max 5 images)
          </p>
        </div>
        {uploadSuccess && (
